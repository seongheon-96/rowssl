    ...
    for epoch in range(args.epochs):
        ...
        for batch_idx, batch in enumerate(train_loader):
            ...
            with torch.cuda.amp.autocast(fp16_scaler is not None):
                contrastive_logits, contrastive_labels, tailness, student_out, student_feat, sup_logits, targets = student(images[0].cuda(non_blocking=True),images[1].cuda(non_blocking=True),labels_for_unimoco,class_labels, args)
                ...
                cluster_loss = cluster_criterion(student_out, teacher_out, class_labels, mask_lab, epoch)
...
if __name__ == "__main__":
    ...
    centers_classifier = torch.randn((100,768))/math.sqrt(100) 
