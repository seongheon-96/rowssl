...
class MoCo(nn.Module):
    ...
    def forward(self, im_q, im_k, class_labels, args, train=True):
        ...
        # instance_wise_tau_ = tau[instance_assign].cuda().detach()
        
        instance_wise_tau = 0.07*torch.ones(128).cuda() # no dynamic temperature
        ...
        return logits, labels, None, torch.cat((q_out,q_out2),dim=0), torch.cat((q_proj,q_proj2)), sup_logits, targets#, instance_assign, self.cluster_center, queue_, lq_
