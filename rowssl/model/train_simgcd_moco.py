...
from model.moco_base import MoCo
    ...
    for epoch in range(args.epochs):
        ...
        for batch_idx, batch in enumerate(train_loader):
            ...
            with torch.cuda.amp.autocast(fp16_scaler is not None):
                ...
                contrastive_logits, contrastive_labels, tailness, student_out, student_feat, sup_logits, target = student(images[0].cuda(non_blocking=True),images[1].cuda(non_blocking=True),labels_for_unimoco,class_labels, args)
