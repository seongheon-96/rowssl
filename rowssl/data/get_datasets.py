...
from data.cifar import get_cifar_10_datasets, get_cifar_100_datasets, get_cifar_10_LT_datasets, get_cifar_100_LT_datasets
from data.herbarium19 import get_herbarium_datasets
from data.stanford_cars import get_scars_datasets
from data.imagenet100 import get_imagenet_100_datasets
from data.cub import get_cub_datasets
from data.fgvc_aircraft import get_aircraft_datasets
from data.inature1k import get_inaturelist18_datasets
from data.Places import get_places_LT_datasets
...
get_dataset_funcs = {
    ...
    'cifar10_LT': get_cifar_10_LT_datasets,
    ...
    'places_LT' : get_places_LT_datasets,
    'inaturelist18': get_inaturelist18_datasets
...
def get_datasets(dataset_name, train_transform, test_transform, args):
    ...
    if args.dataset_name in ['cifar100_LT', 'imagenet_100', 'cub', 'cifar10_LT', 'aircraft', 'scars']:
        
        datasets = get_dataset_f(train_transform=train_transform, test_transform=test_transform,
                                train_classes=args.train_classes,
                                prop_train_labels=args.prop_train_labels,
                                split_train_val = False, imb = args.imb_ratio, rev=args.rev)
    ...
    # unlabelled_train_examples_test.mode = 'test_aug'
...
def get_class_splits(args):
    ...
    if args.dataset_name == 'cifar10':
        ...
        args.image_size = 32
        args.train_classes = range(0,5)
        args.unlabeled_classes = range(5,10)

    elif args.dataset_name == 'cifar100':

        args.image_size = 32
        args.train_classes = range(0,50)
        args.unlabeled_classes = range(50,100)
        
    elif args.dataset_name == 'cifar10_LT':
    ...
    elif args.dataset_name == 'places_LT':

        args.image_size = 224
        args.train_classes = range(182)
        args.unlabeled_classes = range(182, 365)
    ...
    elif args.dataset_name == "inaturelist18":
    
        args.image_size = 224
        inat_path_splits = os.path.join(osr_split_dir, 'inaturelist18_1k_class_splits.pkl')

        with open(inat_path_splits, 'rb') as handle:
            class_splits = pickle.load(handle)
