...
from model.moco_tailness_cluster_forsup import MoCo
...
def train(student, train_loader, test_loader, unlabelled_train_loader, args):
    ...
    for epoch in range(args.epochs):
        ...
        with torch.no_grad():
            all_acc_test_cl2, old_acc_test_cl2, new_acc_test_cl2 = test_inductive(
                student,
                test_loader = test_loader,
                epoch = epoch,
                save_name='Test2 ACC',
        ...
        args.logger.info(
                'Test w/o matching Accuracies CL: All {:.1f} | Old {:.1f} | New {:.1f}'.format(all_acc_test_cl2,
                                                                                    old_acc_test_cl2,
                                                                                    new_acc_test_cl2))
